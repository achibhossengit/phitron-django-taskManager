...
from tasks.views import manager_dashboard, employee_dashboard, create_task, show_all_tasks, update_task, delete_task, task_details, Greatings, HiGreatings, CreateTask
urlpatterns = [
